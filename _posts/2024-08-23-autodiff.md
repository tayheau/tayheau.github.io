...
<table border="2" rules="all" frame="border">
  <caption><span class="table-number">Table 1:</span> Derivatives From Symbolic Differentiation</caption>
  ...
  <thead>
    <tr>
      <th scope="col" class="org-right"> <pre>\\(f(x)\\)</pre> </th>
      <th scope="col" class="org-left">\\(\\frac{d}{dx}f(x)\\) from MATLAB R2021a’s <code>diff(f, x)</code></th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td class="org-right">\\(4(x-1)(x-2)\\)</td>
      <td class="org-left">\\(8x-12\\)</td>
    </tr>
    <tr>
      <td class="org-right">\\(4(x-1)(x-2)(x-3)\\)</td>
      <td class="org-left">\\(4(x - 2)(x - 3) + (4x - 4)(x - 2) + (4x - 4)(x - 3)\\)</td>
    </tr>
    <tr>
      <td class="org-right">\\(4(x-1)(x-2)(x-3)(x-4)\\)</td>
      <td class="org-left">\\((4x - 4)(x - 2)(x - 3) + (4x - 4)(x - 2)(x - 4) + (4x - 4)(x - 3)(x - 4) + 4(x - 2)(x - 3)(x - 4)\\)</td>
    </tr>
  </tbody>
</table>
